...
namespace ProyectoEmpleadosAPI.Datos
{
    ...
    {
        // Constructor que recibe las opciones de configuración de Entity Framework Core
        // y las pasa al constructor de la clase base DbContext.
        public ApplicationDbContext(DbContextOptions<ApplicationDbContext> options): base(options)
        {

        }

        // 2️ Tablas (DbSet) - FUERA del constructor
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Empleado>().ToTable("Empleados").HasDiscriminator<string>("TipoEmpleado")
            ...
            modelBuilder.Entity<PersonalExterno>().ToTable("PersonalExterno").HasDiscriminator<string>("TipoPersonal")
